...
const POLICY_DOC_REF = doc(db, 'settings', 'shippingPolicy');
...
export default function shippingPolicyView() {
  ...
  useEffect(() => {
    async function loadPolicy() {
      try {
        ...
        console.error('Failed to load Shipping and Delivery Policy:', err);
        setError('Failed to load Shipping and Delivery Policy content.');
      } finally {
        setLoading(false);
      }
    }
  ...
  const joditConfig = useMemo(() => ({
    readonly: false,
    placeholder: 'Start writing your Shipping and Delivery Policy here...',
    height: 600,
    style: {
      fontFamily: 'inherit',
      color: '#334155'
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error('Failed to save Shipping and Delivery Policy:', err);
    ...
    return (
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-semibold text-slate-500">Loading Shipping and Delivery Policy…</p>
        </div>
      </div>
    );
  }
      ...
      <div className="sticky top-0 z-20 bg-white/80 backdrop-blur-xl border-b border-slate-200">
        <div className="px-6 lg:px-10 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-extrabold text-slate-800 tracking-tight">Shipping and Delivery Policy</h1>
