              ...
              {user.address && (
                <div className="bg-emerald-50/50 p-4 rounded-2xl border border-emerald-200/60 space-y-2">
                  <p className="text-[10px] font-extrabold uppercase text-emerald-800 tracking-wider flex items-center gap-1.5">
                    <MapPin className="w-3 h-3 text-emerald-600" /> Primary Address
                  </p>
                  
                  {typeof user.address === 'string' ? (
                    <p className="text-xs font-bold text-slate-800 leading-relaxed">{user.address}</p>
                  ) : (
                    <div className="text-xs text-slate-700 leading-relaxed space-y-1">
                      {user.address.fullName && (
                        <p className="font-extrabold text-slate-900">{user.address.fullName}</p>
                      )}
                      {user.address.phone && (
                        <p className="font-bold flex items-center gap-1">
                          <Phone className="w-3 h-3 text-slate-400" /> {user.address.phone}
                        </p>
                      )}
                      ...
                      {user.address.type && (
                        <span className="inline-block mt-1 px-2 py-0.5 bg-emerald-100 text-emerald-700 rounded-md text-[9px] font-bold uppercase tracking-wider">
                          {user.address.type}
                        </span>
                      )}
                    </div>
